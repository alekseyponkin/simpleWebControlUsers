        ...
        <div class="col offset-md-2">
            <form class="form-horizontal" action = "${pageContext.servletContext.contextPath}/" method="post">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter name" title="Name cannot be empty!">
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    <div class="offset-md-7 ">
                        <button type="submit" class="btn btn-primary px-5 mt-3" onclick="return validate();">Add</button>
                    </div>
                </div>
            </form>
        </div>
